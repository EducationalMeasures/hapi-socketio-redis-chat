...
$(document).ready(function () {
  ...
  function getName () {
    ...
    if (!name || name === 'null') {
      name = window.prompt('Please identify yourself as you want to appear in the chatroom (example: Dr Neil Love). You may type in a nickname if you want to remain anonymous.'); // eslint-disable-line
